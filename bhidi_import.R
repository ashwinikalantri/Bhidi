...
dl_one(qx_name = "Sevagram HDSS - Baseline", version = 12, export_type = "tabular",
       folder = "/Volumes/GoogleDrive/Shared drives/HDSS/HDSS Data/Bhidi", unzip = TRUE, 
       server = "mgims", user = "api", password = "Snsph@2018", tries = 10)

unlink("12", recursive = TRUE)

file.rename("MGIMSHDSS_12_TABULAR_All","12")
